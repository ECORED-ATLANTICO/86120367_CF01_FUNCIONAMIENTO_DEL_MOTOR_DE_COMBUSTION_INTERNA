      ...
      SlyderA(tipo="b")
        .row.z-2.justify-content-center.align-items-center
          .col-lg-6
            ...
            p.mb-4.mb-lg-0 En camisas húmedas, se inspeccionan adicionalmente los sellos de goma para detectar agrietamientos o deformaciones, empleando luz UV para identificar microfisuras no visibles a simple vista. 
